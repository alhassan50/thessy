      ...
      <div className="max-w-[1054px] mx-auto">
        ...
        <div className="space-y-20">
          {models.map((model, modelIndex) => (
            <div
              key={modelIndex}
              className="transition-all duration-300 overflow-hidden text-left space-y-4"
            >
              {/* Model Header */}
              ...
              {/* Final Result */}
              {!model.finalImage && <div className="mt-4">
              ...
              {model.finalImage && (
                <div className="mt-4">
                  <h4 className="text-xl font-semibold text-gray-600">
                    Final Look - Image Showcase
                  </h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6 mb-8">
                    {model.finalImage.frontImage && (
                      <div className="relative bg-gray-100 rounded-lg overflow-hidden shadow-md">
                        <Image
                          src={model.finalImage.frontImage}
                    ...
                    {model.finalImage.backImage && (
                      <div className="relative bg-gray-100 rounded-lg overflow-hidden shadow-md">
                        <Image
                          src={model.finalImage.backImage}
                          alt="Final Back View"
                          width={600}
                          height={800}
                          className="w-full h-full object-cover rounded-md"
