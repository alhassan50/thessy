  ...
  return (
    <Section className="!pt-24 text-center space-y-4 relative bg-[url('/assets/grid.svg')] bg-cover bg-center">
      ...
      <div className="grid md:flex gap-4 justify-center items-center">
        <Link href={'/#project'} className="py-4 flex gap-1 items-center group text-[20px] px-8 font-medium rounded-full bg-[var(--primary)] text-[var(--background)] hover:bg-opacity-80 transition">
          Go To Project
          <svg
        ...
        <Link href={'/#contact'} className="py-3 bg-white text-[20px] px-8 font-medium rounded-full hover:underline transition text-[var(--primary)] hover:bg-[#fafafa]">
          Contact Me
        </Link>
      </div>
    </Section>
